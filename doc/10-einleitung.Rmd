...
In Kapitel\ \@ref(datenanalyse) wird die eigentliche Datenanalyse beschrieben. Einleitend wird über das methodische Vorgehen bei der Auswahl der Daten berichtet sowie die Konstruktion der Interaktionsgraphen erläutert.
Der zweite Teil des Kapitels widmet sich dem Topic-Modell der Subreddits und den Ergebnissen der durchgeführten Fallstudie.
