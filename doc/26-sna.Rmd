...
#### Katz-Powell-Index
In Ermangelung einer angemessen prägnanten Übersetzung wird statt der Bezeichnung im urprünglichen Aufsatz hier die Umschreibung "Katz-Powell-Index" oder, wo angemessen, schlicht $\rho_{KP}$ verwendet.  
...
Katz und Powell formulieren für ihren Index zwei Varianten, die im wesentlichen in unterschiedlichen Untersuchungsdesigns begründet liegen.
Fragt man einen Akteur nach einer festen Anzahl Beziehungen, etwa "Nennen Sie die fünf Personen, die Ihnen am nähesten stehen", liegt ein "fixed choice"-Design vor\ [@Katz1955]; wird die Anzahl der Nennungen offen gelassen, liegt die "free choice"-Variante vor.
Die Datenerhebung in dieser Arbeit liefert alle Kommentare eines Nutzers ohne Einschränkung, weshalb hier nur diese Form der Indexbildung beschrieben wird; für die "fixed choice"-Form sei auf die Literatur verwiesen ([@Katz1955], [@Wasserman1994]).

Der Index wird immer für ein Netzwerk als ganzes berechent.
...
Die Werte dieses Index bewegen sich in $-\infty \lt \rho_{KP} \le 1$.
Ein Wert von 0 bedeutet, dass keine Tendenz vorliegt, dass Kanten wechselseitig angelegt sind, ein Wert von 1 signalisiert maximale Tendenz, alle Kanten werden erwidert.
...
Indem die Veränderung bspw. des Knotengrads über die Zeit betrachtet wird, lässt sich feststellen, ob ein Nutzer eher aktiver wird in seinem Kommunikationsverhalten (Grad nimmt zu), oder ob er dieses eher einschränkt.


#### Homophilie
\todo{Braucht man das? Derzeit nicht}
