...
## Methodik {#methodik}
Im Folgenden soll zunächst der verwendete Datensatz kritisch präsentiert werden.
...
Da eine Analyse aller in dieser Stichprobe enthaltenen Nutzer aus Zeitgründen nicht möglich war, wurden drei zufällig ausgewählt und in einer Fallstudie näher betrachtet.
...
Auf einen großen Teil der Topics entfallen vergleichsweise wenig Subreddits: der Hälfte aller Topics sind weniger als neun Subreddits zugeordnet (Median: 9), das Maximum liegt bei 45.577; Tabelle\ \@ref(tab:topic-assignments-summary) im Anhang enthält die Kennzahlen dieser Verteilung.
...
Für die drei in Abschnitt \@ref(stichprobe) ausgewählten Nutzer werden monatliche Interaktionsgraphen erstellt.
