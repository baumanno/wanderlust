...
Im ersten Abschnitt wird das erstellte Topic-Modell analysiert, der zweite Teil erklärt die Ergebnisse der Fallstudie.
...
Bei einer ersten Analyse dieser Wort-Zuordnungen fiel auf, dass die "größten" Topics^["Größe" ist hier bezogen auf die Zahl der einem Topic zugeordneten Subreddits, vgl. Kaptiel\ \@(topicverteilung)] in den vordersten Rängen nahezu ausschließlich Stoppwörter enthielten.
...
(ref:topics-with-stopwords) Häufigste Wörter der vier größten LDA-Topics. Die Spalten enthalten Topic-ID, Anzahl zugeordneter Subreddits und die fünf häufigsten Wörter.
```{r topics-with-stopwords}
tribble(
  ~Topic, ~n, ~Wörter,
  #------------------#
  235,	45577, "the, a, to, i, is",
  122,	34240,	"to, a, for, the, and",
  69,	18504,	"my, a, i, the, this",
  194,	13146, "the, to, for, of, on"
...
In Topic 235 etwa stehen Begriffe wie "subreddit" und "sub" in Nachabrschaft von "like", "go" und "see"; vermutlich ist dieses Topic stark von der Autoreferentialität von Reddit geprägt, ein Umstand, auf den in der Diskussion der Ergebnisse in Kapitel\ \@ref(diskussion) noch näher eingegangen wird.  
...
Topic 210 lässt wenig Zweifel an politischen Ausrichtung des Inhalts, mit Schwerpunkt auf US-amerkanischen Themen ("trump", "president", "donald", "bill", "american").  
Eine allgemein wissenschftliche Ausrichtung lässt sich bei Topic 219 vermuten, mit Begriffen wie "science", "research", "theory" und "study".  
...
Ohne diese Analyse zu tief geraten zu lassen, lässt sich festhalten, dass die Topics des erstellten LDA-Modells hinreichend gut abgeschlossene Themenkomplexe identifiziert haben, die man auch in einem OSN wie Reddit vermuten würde: Hilfe/Selbsthilfe, Selbstdarstellung, Politik, Wissenschaft und Technik, sowie inidividuelle Communities, die in ihrer Landessprache kommunizieren.
Dies alles ist umso bemerkenswerter, als dass es sich hier "nur" um ein mit statistischen Methoden erstelltes Modell menschlicher Spracher handelt, das überdies keine Kenntnis über die Themenverteilung besitzt.

### Fallstudie

Die nächsten drei Unterkapitel befassen sich jeweils mit einem individuellen Nutzer, der aus dem Long Tail der Aktivitätsverteilung für Nutzer gezogen wurde.
Für jeden wurde die Themenhistorie über den gesamten Untersuchungszeitraum von November 2007 bis Februar 2018 erstellt, ebenso wie die zugehörigen Interaktionsgraphen, in denen die Kommunikation mit anderen Nutzern abgebildet ist.
