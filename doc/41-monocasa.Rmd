...
Auch Abbildung \@ref(fig:monocasa-area-chart-alters-full) lässt erkennen, dass in dem gewählten Zeitraum der Anteil der Alteri, die sich ebenfalls an diesem Topic beteiligen, auf 0 sinkt.
...
Die Korrelationen für die beiden größeren Topics 210 und 239 fällt mittel bis star aus und ist signifikant auf dem 0.1%-Niveau.
...
Um dies zu prüfen, werden für den gesamten Graph $G$ und den "monothematischen" Teilgraph $G'$ die Indizes berechnet, sowie die Differenz beiden Maße, $\rho_{kp}(G')-\rho_{KP}(G)$.
